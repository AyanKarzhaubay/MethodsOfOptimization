...
class Dijkstra_s_algorithm
{
    ...
    public static void Run()
    {
        ...
        int[,] graph = new int[,] {   { INF, 1, 3, 7, INF, INF, INF, INF, INF, INF, INF },
        ...
        Dijkstra_s_algorithm t = new Dijkstra_s_algorithm();
        t.dijkstra(graph, 0);
    }
}